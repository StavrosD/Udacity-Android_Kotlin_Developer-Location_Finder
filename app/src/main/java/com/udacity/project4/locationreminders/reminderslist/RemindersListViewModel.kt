...
class RemindersListViewModel(
    ...
    val remindersList = MutableLiveData<MutableList<ReminderDataItem>>()
    ...
    suspend fun deleteReminder(reminder:ReminderDataItem){
        remindersList.value?.remove(reminder)
        dataSource.deleteReminderWithId(reminder.id)
        invalidateShowNoData()
    }

    suspend fun getReminder(id: String) : ReminderDataItem?{
